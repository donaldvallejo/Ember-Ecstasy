  ...
  return (
    <div className="">
      <div className="-mt-52">
        ...
        {/* Vision Section */}
        <div className="bg-black/20 border-primary/20 backdrop-blur-sm p-0 rounded-lg mb-4">
        ...
        <div className="bg-black/20 border-primary/20 backdrop-blur-sm p-0 rounded-lg">
